...
[Install Pociťátko](https://raw.githubusercontent.com/hanenashi/pocitatko/main/pocitatko.user.js) · Current version: **0.5.3**
...
Version 0.5.3 includes two Firestore sign-in choices. A moderator can use the
