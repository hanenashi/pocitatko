...
[Install Pociťátko](https://raw.githubusercontent.com/hanenashi/pocitatko/main/pocitatko.user.js) · Current version: **0.5.1**
...
Version 0.5.1 includes the first Firestore adapter. A moderator can sign in
...
first-party Firebase bridge on mobile browsers and a popup on desktop. The
bridge returns a nonce-checked Google credential in the URL fragment and the
